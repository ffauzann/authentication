...
import (
	...
	"github.com/ffauzann/common/logger"
...
func TestCreateUser(t *testing.T) {
	var (
		...
		user   = &model.User{
			...
			Username:    sql.NullString{String: "johndoe"},
			PhoneNumber: sql.NullString{String: "6281222000212"},
		}
	)
	...
	for _, tt := range tm {
		t.Run(tt.name, func(t *testing.T) {
			...
			err = repo.CreateUser(tt.arg.ctx, tt.arg.user)
